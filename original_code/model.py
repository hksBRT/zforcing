...
class ZForcing(nn.Module):
    ...
    def fwd_pass(self, x_fwd, hidden, bwd_states=None, z_step=None):
        ...
        for step in range(nsteps):
            ...
            if bwd_states is not None:
                ...
                # the inference model combining hidden and backward state
                ...
                # use the infered posterior to inject stochasticity
        ...
        outputs = self.fwd_out_mod(outputs) #final network to predict next states
    ...
    def bwd_pass(self, x, y, hidden):
        ...
        states, _ = self.bwd_mod(x_bwd, hidden) #1lstm
